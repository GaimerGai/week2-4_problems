...
*******************************************************************************/
function isSevenDivis(num){
  if (num % 7 === 0) return true;
  else return false;
}
function isTwoDivis(num){
...
function fuzzBizz(max) {
  let fuzzBizzArr = [];
  for (let i = 1; i < max; i++) {
    if (isTwoDivis(i) && isSevenDivis(i)){
    } else if (isTwoDivis(i)) fuzzBizzArr.push(i)
      else if (isSevenDivis(i)) fuzzBizzArr.push(i)
  }
  return fuzzBizzArr;
}
